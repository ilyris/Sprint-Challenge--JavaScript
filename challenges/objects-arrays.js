...
graduates.forEach( alumni => contactInfo.push(alumni.first_name + " " + alumni.email));

console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */

let unisWithUni = graduates.filter( universities => universities.university.includes("Uni"));
...
const lowCaseAnimalNames = zooAnimals.map( animalsName => animalsName.animal_name.toLowerCase());
...
const populationTotal = zooAnimals.reduce( (accumulator, animals) => accumulator + animals.population, 0);
